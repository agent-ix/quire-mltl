...
| FND-002 | low | Every FR/NFR/ADR relationship target is a real artifact id, checked against the pinned upstream revisions: `tl-mltl` FR-018 (repo HEAD), `quire-observation` FR-004/FR-010/FR-011 (commit `2bdeb833a330bfa777c19eb4c28c423f856f3ba6`, this crate's `Cargo.toml` pin — the working checkout's default branch is a stale feature branch and does not itself carry these ids), `tl-syntax` FR-014, `quire-contract-ir` PGM-01. `quire-observation` FR-009 was checked during authoring but is not cited by any artifact in this PR; the earlier version of this finding over-claimed it as checked-and-cited. | FR-001, FR-002, FR-003, NFR-001, ADR-001 |
